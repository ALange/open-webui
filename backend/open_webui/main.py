...
app.state.config.ENABLE_CHAT_HISTORY_COMPACTION = ENABLE_CHAT_HISTORY_COMPACTION
app.state.config.CHAT_HISTORY_COMPACTION_THRESHOLD = CHAT_HISTORY_COMPACTION_THRESHOLD
app.state.config.CHAT_HISTORY_COMPACTION_START_RATIO = CHAT_HISTORY_COMPACTION_START_RATIO
app.state.config.CHAT_HISTORY_COMPACTION_PROMPT_TEMPLATE = CHAT_HISTORY_COMPACTION_PROMPT_TEMPLATE
